...
/**
   ...
   The socket_file_descriptor argument is a file descriptor that refers to a socket of type SOCK_STREAM or SOCK_SEQPACKET.
...
*/
    ...
    std::cout << "Here is the message: "  << client_addr<<"\n";
